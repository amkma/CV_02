"""
Build script for the cv_core C++ extension module.
...
if sys.platform == "win32":
    ...
    # Auto-detect opencv_world version
    found = False
    if library_dirs:
        import glob
        libs = glob.glob(os.path.join(library_dirs[0], "opencv_world*.lib"))
        # pick the non-debug lib (no 'd' suffix before .lib)
